...
/* =========================
   ...
   ========================= */
const API = {
  index : "<?php echo e(route('carreras.index')); ?>",        // GET ?q=&per_page=
  store : "<?php echo e(route('carreras.store')); ?>",        // POST
  update: id => "<?php echo e(url('admin/carreras')); ?>/"+id,      // POST + _method=PUT
  toggle: id => "<?php echo e(url('admin/carreras')); ?>/"+id+"/toggle", // PATCH
  docentes: (params={}) => {
    const u = new URL("<?php echo e(route('docentes.index')); ?>", window.location.origin);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ldgd2\OneDrive\Documentos\Universidad\si1\Examen\CargaHorariaFict\resources\views/usuarios/admin/admin/carreras/index.blade.php ENDPATH**/ ?>