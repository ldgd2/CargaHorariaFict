...
/* =========================
   ...
   ========================= */
const API = {
  index : "<?php echo e(route('admin.carreras.index')); ?>",        // GET ?q=&per_page=
  store : "<?php echo e(route('admin.carreras.store')); ?>",        // POST
  update: id => "<?php echo e(url('admin/carreras')); ?>/"+id,      // POST + _method=PUT
  toggle: id => "<?php echo e(url('admin/carreras')); ?>/"+id+"/toggle", // PATCH
  docentes: (params={}) => {
    const u = new URL("<?php echo e(route('admin.docentes.index')); ?>", window.location.origin);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyecto\CargaHorariaFict\resources\views/usuarios/admin/admin/carreras/index.blade.php ENDPATH**/ ?>