...
<?php $__env->startSection('title', 'Auditoría y Conflictos de Carga'); ?>
...
<div class="app-container p-4 sm:p-6 lg:p-8 min-h-screen bg-gray-50">
	...
	<div class="flex space-x-4 mb-8">
		...
		<a href="<?php echo e(route('coordinador.reportes.index')); ?>" 
					...
					<div>
						...
						<select name="periodo_id" id="periodo_id_audit" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-red-500 focus:ring-red-500 transition duration-150">
							...
							<?php $__empty_1 = true; $__currentLoopData = $periodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
								<option value="<?php echo e($periodo->id_periodo); ?>">
					...
					<div>
						...
						<select name="carrera_id" id="carrera_id_audit" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-red-500 focus:ring-red-500 transition duration-150">
							...
							<?php $__empty_1 = true; $__currentLoopData = $carreras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrera): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
								<option value="<?php echo e($carrera->id_carrera); ?>">
...
<script>
	...
	document.addEventListener('DOMContentLoaded', function () {
		...
		function refrescarAuditoria() {
			...
			fetch("<?php echo e(route('coordinador.auditoria.refrescar')); ?>", {
				method: 'POST',
				headers: {
		...
		function listAuditoria() {
			...
			const url = new URL("<?php echo e(route('coordinador.auditoria.listar')); ?>");
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Larabel2\CargaHorariaFict\resources\views/auditoria/index.blade.php ENDPATH**/ ?>