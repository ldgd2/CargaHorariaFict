...
<div class="form-group mb-4">
  ...
  <select id="carrera-select" class="form-control" onchange="loadMaterias(this.value)">
    ...
    <?php $__currentLoopData = $carreras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrera): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <option value="<?php echo e($carrera->id_carrera); ?>"><?php echo e($carrera->nombre); ?></option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ldgd2\OneDrive\Documentos\Universidad\si1\Examen\CargaHorariaFict\resources\views/asistencia/selector_qr.blade.php ENDPATH**/ ?>