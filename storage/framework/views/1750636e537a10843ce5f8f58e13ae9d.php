...
<?php $__env->startSection('title', 'Gestión de Publicación y Reapertura'); ?>
    ...
    <div class="bg-white rounded-xl shadow-xl overflow-hidden">
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="overflow-x-auto">
                ...
                <?php if($periodos_carrera->isEmpty()): ?>
                ...
                <?php else: ?>
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $periodos_carrera; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-indigo-50/50 transition duration-100">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    <?php echo e($item->periodo); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                    <?php echo e($item->carrera); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    ...
                                    <?php elseif($item->estado === 'Borrador'): ?>
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">
                                            Listo para Publicar
                                        </span>
                                    <?php elseif($item->estado === 'Reabierto'): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    <?php if(($is_coordinator || $is_admin) && ($item->estado === 'Borrador' || $item->estado === 'Reabierto')): ?>
                                        <button type="button" 
                                            onclick="showConfirmModal(<?php echo e($item->id); ?>, '<?php echo e($item->periodo); ?>', '<?php echo e($item->carrera); ?>', 'publish')"
                                    ...
                                    <?php if($is_admin && $item->estado === 'Publicado'): ?>
                                        <button type="button" 
                                            onclick="showConfirmModal(<?php echo e($item->id); ?>, '<?php echo e($item->periodo); ?>', '<?php echo e($item->carrera); ?>', 'reopen')"
                                    ...
                                    <?php elseif($item->estado !== 'Borrador' && $item->estado !== 'Publicado' && $item->estado !== 'Reabierto'): ?>
...
<script>
    ...
    async function performPublish(id_periodo, periodo, carrera) {
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route("coordinador.gestion_ciclo.publicar")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Token CSRF Obligatorio
                },
                body: JSON.stringify({
    ...
    async function performReopen(id_periodo, periodo, carrera, motive) {
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route("coordinador.gestion_ciclo.reabrir")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Token CSRF Obligatorio
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Larabel2\CargaHorariaFict\resources\views/horarios/publicacion_reapertura.blade.php ENDPATH**/ ?>